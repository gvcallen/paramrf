...
All of the above methods take a "solver" argument. ParamRF allows for optimization and inference using a number of backends, namely :func:`scipy.optimize.minimize`, :func:`optimistix.minimise`, :mod:`jaxopt`, :func:`pypolychord.run` and :mod:`blackjax`.
...
* **JAXopt**: More JAX-native algorithms, such as :class:`optimistix.LBFGSB`.
