...
class Target:
    ...
    """
    def __init__(self, model: Model, measured: skrf.Network = None, use_measured = False, fixed = False,
    ...
    @property
    def model(self) -> Model | skrf.Network:
    ...
    @property
    def residual(self) -> skrf.Network:
    ...
    def features(self, measured = False, ignore_imag=False) -> np.ndarray:
        ...
        if measured:
            ...
            network = self.model
        y = extract_features(network, self.features_list, ignore_imaginary=ignore_imag)
        return y
