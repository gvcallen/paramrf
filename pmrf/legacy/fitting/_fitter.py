...
from pmrf._misc.structures import frequency_to_dict, dict_to_frequency
...
from _model import ParametricNetwork
...
class NetworkFitter:
    ...
    def feature_matrix(self, features=None, separate=False, ignore_imag=False) -> np.ndarray:
        ...
        y_target = extract_features(target_networks, feature_extractors, ignore_imaginary=ignore_imag)
