...
class _DelegatedModel(Model, ABC):
    """Internal base for models whose RF behaviour is supplied by another model."""

    @abstractmethod
    def _model(self) -> Model:
        """Return the model that supplies the delegated RF interface."""
...
class AbstractBuilder(_DelegatedModel):
