...
| **Paper** | [ParamRF: A JAX-Native Framework for Declarative Circuit Modelling](https://arxiv.org/abs/2510.15881) |
...
If you have used ParamRF for academic work, please cite the original [paper](https://arxiv.org/abs/2510.15881):

``
@misc{allen2025paramrfjaxnativeframeworkdeclarative,
      ...
      archivePrefix={arXiv},
      primaryClass={cs.OH},
      url={https://arxiv.org/abs/2510.15881}, 
}
``